...
| `monolith.image.repository`    | Monolith image repository                       | `ghcr.io/pvmasny/yandex-arch-pro-02/monolith` |
...
| `proxyService.image.repository`| Proxy service image repository                  | `ghcr.io/pvmasny/yandex-arch-pro-02/proxy-service` |
...
| `moviesService.image.repository`| Movies service image repository                | `ghcr.io/pvmasny/yandex-arch-pro-02/movies-service` |
...
| `eventsService.image.repository`| Events service image repository                | `ghcr.io/pvmasny/yandex-arch-pro-02/events-service` |
